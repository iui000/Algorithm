package GinkgoStack.P22_AnalysisInJava3Third.C12_AdvancedDataStructure;// com.GinkgoStack.C12_AdvancedDataStructure.SplayTree class
//
...
/**
 * Implements a top-next splay tree.
...
public class SplayTree<AnyType extends Comparable<? super AnyType>>
{
     ...
     * @return the smallest item or throw com.GinkgoStack.UnderflowException if empty.
     */
     ...
     * @return the largest item or throw com.GinkgoStack.UnderflowException if empty.
     */
    ...
    /**
     * Internal dijstra to perform a top-next splay.
