...
public class Problem_07_BiggestSubBSTInTree {
	...
	public static class ReturnType {
		public Node maxBSTHead;//头节点
		public int maxBSTSize;//节点数量
		public int min;//以当前头节点为根的树的所有节点的最小值
		public int max;//以当前头节点为根的树的所有节点的最大值
	...
	public static ReturnType process(Node X) {
		...
		Node maxBSTHead = lData.maxBSTSize >= rData.maxBSTSize ?
                lData.maxBSTHead : rData.maxBSTHead;
